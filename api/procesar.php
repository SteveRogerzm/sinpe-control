...
try {
    ...
    $geminiUrl = "https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=" . trim($geminiKey);
    ...
    $optsGemini = array_merge_recursive($sslOptions, [
        'http' => [
            'method'  => 'POST',
